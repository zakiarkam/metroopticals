      ...
      <section className="overflow-hidden py-8 bg-gradient-to-b from-gray-50 to-gray-100">
        <SiteContainer>
          <div className="flex flex-col xl:flex-row gap-5">
            <div className="xl:flex-[0.32] w-full  bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg border border-gray-200">
            ...
            <div className="xl:flex-[0.68] w-full bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 lg:p-8">
              <div className="mb-5">
