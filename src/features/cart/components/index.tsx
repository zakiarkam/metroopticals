  ...
  return (
    <>
      {cartItems.length > 0 ? (
        <section className="overflow-hidden md:p-8 py-8 bg-gradient-to-b from-gray-50 to-gray-100">
          <SiteContainer>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_370px] gap-6 lg:gap-8 items-start">
              <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg border border-gray-200 w-full">
        ...
        <section className="p-8 bg-gradient-to-b from-gray-50 to-white">
