...
export default function MetroOpticalsHero() {
  return (
    <div className="relative bg-gradient-to-br from-gray-1 via-blue-light-5 to-blue-light-3 overflow-hidden">
      ...
      <div className="relative z-10  mx-auto px-4 sm:px-6 lg:px-16 pt-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-8rem)]">
          ...
          <div className="space-y-8">
            {/* Badge */}
            {/* <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-2 shadow-sm border border-blue-light-5 rounded-full">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-gray-2 to-transparent"></div>
    </div>
  );
}
