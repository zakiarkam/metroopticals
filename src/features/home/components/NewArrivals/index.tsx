  ...
  return (
    <div className="relative p-2 overflow-hidden">
      <button
        ...
        className="absolute left-1 top-1/2 z-10 h-10 w-10 -translate-y-1/2 rounded-full border border-gray-200 bg-white/80 text-dark transition hover:border-dark hover:bg-white disabled:cursor-not-allowed disabled:border-gray-200 disabled:bg-gray-100"
      >
      ...
      <button
        ...
        className="absolute right-1 top-1/2 z-10 h-10 w-10 -translate-y-1/2 rounded-full border border-gray-200 bg-white/80 text-dark transition hover:border-dark hover:bg-white disabled:cursor-not-allowed disabled:border-gray-200 disabled:bg-gray-100"
      >
        <span className="text-xl">&#8250;</span>
      </button>
      <div
